  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white font-sans">
      ...
      <div className="flex w-full h-screen max-w-[1440px]">
          ...
          <div className="w-full max-w-sm">
            ...
            <form className="space-y-6">
              ...
              <div className="flex items-center justify-between pt-4">
                ...
                <button
                  type="submit"
                  className="bg-[#2D7344] hover:bg-[#235e36] text-white text-sm font-medium py-2 px-8 rounded-sm transition-colors"
                >
                  Login
                </button>
              </div>
        ...
        {/* BAGIAN KANAN: Ilustrasi (Disembunyikan di layar HP, muncul di layar besar) */}
        <div className="hidden lg:flex lg:w-1/2 bg-[#EAFBF0] rounded-l-[40px] items-center justify-center my-4 mr-4 relative overflow-hidden">
          {/* Ganti div placeholder ini dengan tag img:
            <img src="/path-ke-gambar-ilustrasi-kamu.png" alt="Ilustrasi" className="w-3/4 max-w-lg object-contain" />
          */}
          ...
          {/* Elemen Dekoratif Dot Hijau (Opsional, untuk menyesuaikan contoh) */}
