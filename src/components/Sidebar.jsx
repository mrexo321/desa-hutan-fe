...
import { ChevronLeft, Menu, X, Leaf, LogOut } from "lucide-react";
import { homeMenus, metadataMenus } from "../constants/sidebarMenus";

// 1. Import hook usePermission yang sudah kamu buat
import { usePermission } from "../hooks/usePermission"; // Sesuaikan path jika berbeda

const Sidebar = React.memo(function Sidebar({ activeMenu }) {
  const [isCollapsed, setIsCollapsed] = useState(false);
  const [isOpenMobile, setIsOpenMobile] = useState(false);

  // 2. Panggil hook untuk mendapatkan fungsi 'can'
