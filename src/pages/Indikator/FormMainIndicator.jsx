    ...
    <DashboardLayout activeMenu="Indikator">
      <main className="flex-1 flex flex-col h-full relative overflow-hidden bg-[#FAFBFC]">
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-6">
          ...
          >
            {/* KOLOM KIRI: INFORMASI DASAR (Menghabiskan 7 Kolom) */}
            <div className="xl:col-span-7 bg-white rounded-[24px] p-6 md:p-8 shadow-sm border border-slate-200">
            ...
            {/* KOLOM KANAN: NILAI INDIKATOR / DYNAMIC ARRAY (Menghabiskan 5 Kolom, Sticky) */}
            <div className="xl:col-span-5 bg-slate-50 border border-slate-200 rounded-[24px] shadow-sm flex flex-col xl:sticky xl:top-6 max-h-[calc(100vh-140px)] overflow-hidden">
                      ...
                      <div className="space-y-3">
                        <div>
                          <input
                            ...
                            value={item.label}
                            onChange={(e) =>
                              handleNilaiChange(index, "label", e.target.value)
                            }
