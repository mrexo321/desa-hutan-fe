          ...
          <div className="bg-white rounded-2xl shadow-[0_4px_20px_rgb(0,0,0,0.03)] border border-gray-100 flex flex-col">
              ...
              <table className="w-full text-left border-collapse whitespace-nowrap">
                <thead>
                  <tr className="bg-gray-50/50 border-b border-gray-100 text-[11px] uppercase tracking-wider font-bold text-gray-500">
                    <th className="py-4 px-6 w-24">Kode</th>
                    <th className="py-4 px-6">Nama Indikator</th>
                ...
                <tbody className="text-sm font-medium text-gray-700">
                  {tableData.map((row, idx) => (
                    ...
                    >
                      ...
                      <td className="py-4 px-6 text-gray-900">{row.nama}</td>
                      <td className="py-4 px-6">
                        <span
                          className={`px-3 py-1 rounded-md text-xs font-bold border ${row.badgeColor}`}
                        >
                          {row.kategori}
                        </span>
                      </td>
                  ...
                  {/* State Kosong (Opsional, jika data tidak ada) */}
                  {tableData.length === 0 && (
                    <tr>
                      <td
                        colSpan="4"
                      ...
                      >
                        Belum ada data indikator yang ditambahkan.
                      </td>
                    </tr>
                  )}
                </tbody>
            ...
            <div className="p-4 md:p-6 border-t border-gray-50 flex flex-col md:flex-row justify-between items-center gap-4 bg-gray-50/30 rounded-b-2xl">
              <p className="text-xs font-medium text-gray-500">
                Menampilkan baris{" "}
                <span className="font-bold text-gray-900">1 - 5</span> dari{" "}
