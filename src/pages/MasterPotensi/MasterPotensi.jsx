...
const MasterPotensi = () => {
  // Mock Data untuk Master Potensi
  const tableData = [
    { id: 1, no: 1, kategori: "Ekonomi", nama: "Perikanan" },
    { id: 2, no: 2, kategori: "Ekonomi", nama: "Pertanian" },
    { id: 3, no: 3, kategori: "Ekonomi", nama: "Kehutanan" },
    { id: 4, no: 4, kategori: "Ekonomi", nama: "Perkebunan" },
    { id: 5, no: 5, kategori: "Pariwisata", nama: "Ekowisata Alam" },
    { id: 6, no: 6, kategori: "Pariwisata", nama: "Wisata Budaya" },
    { id: 7, no: 7, kategori: "Lingkungan", nama: "Karbon Biru (Blue Carbon)" },
    { id: 8, no: 8, kategori: "Sosial", nama: "Kerajinan Tangan Lokal" },
  ];
        ...
        <div className="flex-1 overflow-y-auto px-6 md:px-10 py-8 custom-scrollbar">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-gray-500 mt-1">
              Kelola data master untuk berbagai jenis potensi yang ada di
              wilayah desa hutan.
            </p>
          </div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-green-50 flex items-center justify-center text-[#2D7344] shrink-0">
                    {/* Ikon Sprout (Tunas) melambangkan potensi yang bisa bertumbuh */}
              ...
              <table className="w-full text-left border-collapse whitespace-nowrap">
                <thead>
                  <tr className="bg-gray-50/50 border-b border-gray-100 text-[11px] uppercase tracking-wider font-bold text-gray-500">
                    ...
                    <th className="py-4 px-6 w-64">Kategori</th>
                    <th className="py-4 px-6">Nama Potensi</th>
                ...
                <tbody className="text-sm font-medium text-gray-700">
                  {tableData.map((row) => (
                    ...
                    >
                      ...
                      <td className="py-4 px-6">
                        {/* Sistem Badge Berwarna untuk Kategori */}
                        <span
                          className={`px-3 py-1.5 rounded-md text-xs font-bold border ${getCategoryBadge(row.kategori)}`}
                        >
                          {row.kategori}
                        </span>
                      </td>
                  ...
                  {tableData.length === 0 && (
                    <tr>
                      ...
                      >
                        Belum ada data potensi yang ditambahkan.
                      </td>
                    </tr>
                  )}
                </tbody>
