            ...
            <table className="w-full text-left border-collapse min-w-[1200px]">
              <thead>
                <tr className="bg-[#2D7344] text-white text-xs font-bold leading-tight">
                  <th className="py-3 px-4 text-center w-12 border-r border-[#3A8353]">
                    No
                  </th>
                  <th className="py-3 px-4 border-r border-[#3A8353] min-w-[150px]">
                    Nama Desa
                  </th>
                  <th className="py-3 px-4 border-r border-[#3A8353] w-28">
                    Indeks Desa Membangun (IDM)
                  </th>
                  <th className="py-3 px-4 border-r border-[#3A8353] w-28">
                    Indeks Ketahanan Pangan (IKP)
                  </th>
                  <th className="py-3 px-4 border-r border-[#3A8353]">
                    Rawan Banjir
                  </th>
                  <th className="py-3 px-4 border-r border-[#3A8353]">
                    Rawan Longsor
            ...
            <div className="p-6">
              ...
              <div className="mb-5">
                ...
                <input
                  type="text"
                  defaultValue="2025"
                  className="w-full border border-gray-300 rounded-lg p-3 text-sm text-gray-700 focus:outline-none focus:border-[#4CAF50]"
                />
              </div>
