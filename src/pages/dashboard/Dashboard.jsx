          ...
          <div className="mb-6">
            ...
            <ul className="space-y-1">
              <li>
                <a
                  href="#"
                  className="flex items-center gap-3 bg-[#2D7344] text-white px-4 py-2.5 rounded-lg text-sm font-medium shadow-sm"
                >
                  <svg
                    width="18"
                    height="18"
              ...
              <li>
                <a
                  href="#"
                  className="flex items-center gap-3 text-gray-600 hover:bg-gray-100 px-4 py-2.5 rounded-lg text-sm font-medium transition-colors"
                >
                  <svg
                    width="18"
                    height="18"
                  ...
                  >
                    <path d="M17.5 19c-2.5 0-4-2-4-2s-1.5 2-4 2-4-2-4-2V5c0 0 1.5 2 4 2s4-2 4-2 1.5 2 4 2 4-2 4-2v12c0 0-1.5 2-4 2z" />
                  </svg>
                  Desa Hutan
                </a>
              </li>
